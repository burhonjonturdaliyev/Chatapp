...
class _chatappState extends State<chatapp> {
  ...
  Widget _BScard(int value){
    String url="";
    if(value==1) {
       url = "https://matwrites.com/wp-content/uploads/2018/03/Flutter.png";
    }
      else if(value==2){
    url="https://image.shutterstock.com/image-vector/banner-social-media-marketing-technology-260nw-1142740865.jpg";
      }
      else if(value==3){
        url="https://www.uxdesigninstitute.com/blog/wp-content/uploads/2022/04/101_ux_vs_ui_illustration_blog.png";
            }
      else if(value==4){
        url="https://res.cloudinary.com/practicaldev/image/fetch/s--EfIG-oPF--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://thepracticaldev.s3.amazonaws.com/i/ssqkgebqme30hf4fwmw0.png";
    }
    ...
    return Scaffold(
          ...
          children: [
            new UserAccountsDrawerHeader(
              ...
              currentAccountPicture: new CircleAvatar(
                child: new Image.asset("Image/Icon_user.png",),
              ),
            ),
            new ListTile(
              title: new Text(
      ...
      body: ListView(
        ...
        children: [
         ...
         _BScard(1),
          _BSdetails("B.Tech (2 YEAR)", "Burkhan is owner of this application",1),
        //Sherali
          _BScard(2),
          _BSdetails("B.Tech (2 YEAR)", "Sherali is owner of this application",2),
       //Muhammadali
          _BScard(3),
          _BSdetails("B.Tech (2 YEAR)", "Muhammadali is owner of this application",3),

          //Akbarshokh
          _BScard(4),
          _BSdetails("B.Tech (2 YEAR)", "Akbarshokh is owner of this application",4),
        ],
      ),
